...
$tableData = "";
$sqlQuary = "SELECT ph.*, s.slot_name FROM parking_history ph JOIN solts_table s ON ph.slotId = s.slotId";
$result = $conn->query($sqlQuary);
if($result->num_rows > 0){
    $count = 1;
    while($row = $result->fetch_assoc()){
...
<body>
    ...
    <div style="margin: 30px;">
        <h1 style="margin-bottom: 30px;">Parking History</h1>
